...
* `addto PROJECT_NAME userstory [story]` -- Adds the `story` to the project indicated by the `PROJECT_NAME`.
...
* `edit project PROJECT_NAME userstory INDEX [story]` -- Edits the user story at the specific index of the `SortedUserStoryList` in the project indicated by the `PROJECT_NAME`.
