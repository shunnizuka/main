...
[width="100%",cols="35%,30%,<35%"]
|===
|Format |Chooses the date relative to the ... |How it Works

|`today/tomorrow/yesterday`
|current day
|today's, tomorrow's or
yesterday's date are translated into the DD/MM/YYYY format based on the input
