...
abstracted into a `AddToCommand` class which inherits from `Command` class. Refer to the Class Diagram below for a better visualization of the inheritance relationship.
