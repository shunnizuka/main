...
=== Listing the list of projects/employees

. Listing employees/projects from a pocket project with several of each in the storage

.. Test case: `list employees" +
   Expected: The list of all employees are listed
