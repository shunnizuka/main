...
This operations is supported by the `Model#addUserStoryTo(Project, UserStory)` method in the `Model` interface.
...
image:ug-lightbulb.png[width="50"]
Tip: The `[project name]` entered must be valid and exists in the app. The `[project index]` given must refer to some existing project. Also,
the user story added needs to be of the correct format. If not, exceptions would be thrown during the execution of the command.

[width="100%",cols="35%,<65%"]
|===
|image:ug-exclamation.png[width="60"]| The `[project name]` entered must be valid and exists in the app. The `[project index]` given must refer to some existing project. Also,
                                       the user story added needs to be of the correct format. If not, exceptions would be thrown during the execution of the command.
