...
+
Use case resumes at step 2.
* 3b. The project name specified is invalid.
+
[none]
** 3b1. PocketProject shows an error message.
+
Use case resumes at step 2.

=== Use case: Add employee to project
...
+
Use case resumes at step 2.
* 3b. The project name given is invalid.
+
[none]
** 3b1. PocketProject shows an error message.
+
Use case resumes at step 2.
* 3c. The employee is already in the project.
+
[none]
** 3c1. PocketProject shows an error message.
+
Use case resumes at step 2.

=== Use case: Remove employee from project
...
=== Use case: Editting an employee details
...
* 3a. The new employee has the exact same details as another employee.
+
[none]
** 3a1. PocketProject shows an error message.
+
...
=== Use case: Add milestone to project
...
*Extensions*
* 1a. The milestone to be added is already specified in the project.
+
[none]
** 1a1. PocketProject shows an error message.
+
Use case ends.

=== Use case: Remove milestone from project
...
=== Use case: Add user story to project
...
*Extensions*
* 1a. The user story to be added is already specified in the project.
+
[none]
** 1a1. PocketProject shows an error message.
+
...
=== Use case: Remove user story from project
...
=== Use case: Add project task to project
...
*Extensions*
* 1a. The project task to be added is already specified in the project.
+
[none]
** 1a1. PocketProject shows an error message.
+
...
=== Use case: Remove project task from project
...
* 3a. The given milestone index is invalid.
+
[none]
** 3a1. PocketProject shows an error message.
+
...
.. Test case: `complete 1` where there this at least one project shown in the list of projects +
...
.. Test case: `complete Project Apollo` where there is a project named 'Project Apollo' in the app +
   Expected: The project named 'Project Apollo' is removed from the list of ongoing projects and indicated as completed. Timestamp shown in the status bar is updated.
.. Test case: `complete x` where x is neither the index of a displayed project nor the name of an existing project +
