...
These operations are supported by the methods in the `Model` interface: `Model#addEmployeeTo(Project, Employee)`, `Model#addMilestoneTo(Project, Milestone)` and `Model#addUserStoryTo(Project, UserStory)`.
...
* `addto [project name] userstory i/STORY_IMPORTANCE [story]` -- Adds the `story` to the project indicated by the `PROJ_NAME`.
* `removefrom [project name] userstory [userstory index]` -- Removes the user story at the specific index of the `SortedUserStoryList` in the project indicated by the `[project name]`.
* `edit project [project_name] userstory [userstory index] [story]` -- Edits the user story at the specified index of the `SortedUserStoryList` in the project indicated by the `[project name]`.
* `update [project_name] userstory [userstory index] [status]` -- Updates the status of the user story at the specified index of the `SortedUserStoryList` in the project indicated by the `[project name]`.
...
This operation is supported by the `Model#addUserStoryTo(Project, UserStory)` method in the `Model` interface.
...
Given below is an example usage scenario and how the addition of user story to a project feature behaves at each step.
...
This operation is supported by the `Model#removeUserStoryFrom(Project, UserStory)` method in the `Model` interface.
...
Given below is an example usage scenario and how the removal of a user story feature behaves at each step.
...
This operation is supported by the `Project#SetUserStory(UserStory, UserStory)` method in the `Project` class. It takes
...
Given below is an example usage scenario and how the editing of a user story feature behaves at each step.
