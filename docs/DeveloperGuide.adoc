...
Refer to the Activity Diagram above while reading the explanation that follows so as to have a better
understanding of how it works

When a date input is received, it will first be parsed
*Fixed Date Format*
...
.Activity Diagram: Showing how a fixed and flexible date format is parsed and processed.
image::dg-activitydiagdate.png[width="600"]
...
image::dg-codesnippet.png[width="700"]
...
image::dg-addemployeeto.png[width="700"]
