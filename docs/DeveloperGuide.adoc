...
image::dg-activitydiagdate.png[width="700"]
...
image::dg-addemployeeto.png[width="800"]
...
. The rest of the execution process is similar to Steps 4 - 8 of the *Add Employee To Command* mentioned above except that
