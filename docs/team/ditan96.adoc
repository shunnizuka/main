...
You can view this section to see my contributions to the Developer Guide documentation which consists of the implementation of the project task feature as well as a several sections on manual testing of Pocket Project.

include::../DeveloperGuide.adoc[tag=projecttask]
include::../DeveloperGuide.adoc[tag=daryl]