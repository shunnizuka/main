...
extensively in other features. So, smart dates enable the user a quick and user-friendly way
...
parser is designed to differentiate based on the input received.
