...
* Documentation
** Enhanced documentation of existing features such as *help*: [https://github.com/cs2103-ay1819s2-w10-2/main/pull/229[#229]]
...
include::../UserGuide.adoc[tag=addfeature]
include::../UserGuide.adoc[tag=addemployee]
include::../UserGuide.adoc[tag=addmilestone]
