...
* Documentation
** Enhanced documentation of existing and new features such as `help`, `add employee/project` among others: https://github.com/cs2103-ay1819s2-w10-2/main/pull/229[#229]
...
** Refer to <<Contributions to the User Guide>> and <<Contributions to the Developer Guide>> for more details.
...
In this section, I detail some of the key contributions I made to the User Guide targeted and helping users
understand how to use the application.

include::../UserGuide.adoc[tag=datefeature]
include::../UserGuide.adoc[tag=addmilestone]

This section is not exhaustive of my contributions and the rest can be
viewed at https://github.com/cs2103-ay1819s2-w10-2/main/blob/master/docs/UserGuide.adoc[Pocket Project: User Guide]

=== Contributions to the Developer Guide
In this section, I detail some of the key contributions I made to the Developer Guide targetted at helping
