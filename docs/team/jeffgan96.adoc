...
In this section, I will showcase some of my contributions to the User Guide to demonstrate my ability to write documentation targetting users of Pocket Project. Note that the snippets shown here are not an exhaustive list of all my contributions.
...
to our Developer's Guide: [https://github.com/cs2103-ay1819s2-w10-2/main/blob/master/docs/DeveloperGuide.adoc]

include::../DeveloperGuide.adoc[tag=ui]
include::../DeveloperGuide.adoc[tag=adduserstory]
include::../DeveloperGuide.adoc[tag=removeuserstory]
