...
My team and I were given the task to enhance or morph a basic command line interface Addressbook for our software engineering Project. Our team decided to morph the AddressBook into a project management tool named Pocket Project. Pocket Project is designed to suit the needs of software engineering managers by enabling them to store all the information that are essential for software engineering project planning such as employees, projects, milestones, user stories and tasks so as to make planning projects easier and more convenient for them.
...
*** Change the behaviour of `edit` to `edit employee` command so that it will automatically update the employee in the project as well (Pull Request {empty}[https://github.com/cs2103-ay1819s2-w10-2/main/pull/118[118]])
*** Design the UI for the employee summary panel (Pull Request {empty}[https://github.com/cs2103-ay1819s2-w10-2/main/pull/155[155]])
*** Set up Project Description class (Pull Request {empty}[https://github.com/cs2103-ay1819s2-w10-2/main/pull/72[72]])
** Documentation:
*** Update the Class diagrams for the components in DG to fit the latest version of the application (Pull Requests {empty}[https://github.com/cs2103-ay1819s2-w10-2/main/pull/147[147]])
*** Added instruction on navigating Pocket Project interface in UG (Pull Request {empty}[https://github.com/cs2103-ay1819s2-w10-2/main/pull/174[174]]
** Community:
** Tools:
*** Set up reposense
