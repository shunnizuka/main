...
[width="100%",cols="35%,<65%"]
|===
|image:ug-notepadpencil.png[width="60"]|You do not need to specify which format you are planning to use and the application
is able to differentiate it based on the input received.
|===

[width="100%",cols="35%,<65%"]
|===
|image:ug-lightbulb.png[width="50"]|The application will also automatically help to check the validity of the target
...
edited using the `edit project info` command. Refer to <<Edits name/client/deadline/description of a project: `edit project info`>>
|===
...
can be used to select the target `START_DATE` and `DEADLINE`. Refer to <<Date Feature in Pocket Project>>
|===
