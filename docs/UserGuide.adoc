...
[width="1000",cols="100,<900"]
|===
|image:ug-lightbulb.png[width="40"]| You can input the importance level or the actual user story in any order.
|image:ug-lightbulb.png[width="40"]| A valid user story can also be simply: `as a ... i want to...`.
