...
==== Edit name/client/deadline/description of a project: `edit project info`
...
==== Edit user story in a project: `edit project userstory`
...
image::edit-user-story-ui.png[width="500"]
// end::edituserstory[]
