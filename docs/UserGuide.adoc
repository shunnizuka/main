...
[width="1000",cols="100,<900"]
|===
|image:ug-notepadpencil.png[width="50"]|The `DAY_OF_WEEK` takes an integer in the range of 1 to 7 which
...
[width="1000",cols="100,<900"]
|===
|image:ug-notepadpencil.png[width="50"]|An employee can have any number of skills (including 0).
|===
