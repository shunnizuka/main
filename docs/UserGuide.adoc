...
==== Remove an employee from a project: `removefrom employee`
...
==== Remove a milestone from a project: `removefrom milestone`
...
=== To indicate the project has been completed : `complete` [coming in v2.0]

Indicates that a project is completed +
Format: `complete PROJECT_NAME`
or `complete PROJECT_INDEX`

Examples:

`complete Project Apollo` +
Project Apollo is indicated as completed.

`complete 1`
The first project in the most recently display list of projects is completed.
