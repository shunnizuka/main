...
|image:ug-exclamation.png[width="70"]|
Note that there is a minor bug that does not allow 'info' as part of the argument for the description of the project (e.g. 'desc/A project info...' is not accepted). We are working hard to fix this issue soon.
|===
...
|image:ug-exclamation.png[width="50"]|
Note that there is a minor bug that does not allow 'milestone' as part of the argument for the description of the milestone (e.g. 'm/A milestone for ui' is not accepted). We are working hard to fix this issue soon.
|===
