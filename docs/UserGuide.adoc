...
You can add a user story to a project which is useful in the planning stage of a project where the implementation
...
* `delete project 1` +
Deletes the first project shown in the most recent displayed list of projects. Figure 16 shows the command being typed but not entered yet
and figure 17 shows the effect of the command.
...
Below is the before and after screenshots when the command `edit project PocketProjcet info desc/A project management tool d/20/05/2019`.

.Before entering the edit project command
image::edit_project_before.png[]

.After the edit project command is entered
