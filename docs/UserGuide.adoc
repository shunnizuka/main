...
Step 1: `find Bernice` - to narrow down the list to all employees with name containing Bernice

image::findEmployeeBernice.png[width="800"]
 
Step 2: `delete 1` - deletes Bernice Yu who is the 1st employee in the result of the `find Bernice` command.
