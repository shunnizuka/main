...
PocketProject is for managers who have difficulty managing numerous projects that they are working on as well as the many employees that are under their charge. This application helps to keep track of employees responsible for each component of the project and also the workload of each employee.Thus, making it easier for managers to allocate and assign roles as required for different projects as well as manage their employees better.
