...
The light bulb icon will be used to represent any useful tips that users
can take note of while using the PocketProject application.

image:ug-exclamation.png[width="50"]
The exclamation mark icon will be used to represent any warning that users
can take note of while using the PocketProject application.

image:ug-smart.png[width="60"]
The graduation cap icon will be used to represent any advanced usages or
