...
[width="1000",cols="100,<900"]
|===
|image:ug-notepadpencil.png[width="60"]| Clicking on the arrow beside a milestone containing existing tasks allows you
...
[width="1000",cols="100,<900"]
|===
|image:ug-exclamation.png[width="50"]| The `MILESTONE_INDEX` and `PROJECT_TASK_INDEX` must be a positive integer and cannot be
