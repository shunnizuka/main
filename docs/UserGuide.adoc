...
You can add an employee to the application so that projects can be
assigned to him/her.
...
.What happens when we add an employee to the application
image::UserGuide-addemployee.png[]
