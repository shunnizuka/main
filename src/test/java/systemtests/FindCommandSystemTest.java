...
public class FindCommandSystemTest extends AddressBookSystemTest {
    ...
    public void find() {
        ...
        command = FindEmployeeCommand.COMMAND_WORD + " " + FindEmployeeCommand.TYPE + " Carl";
        ...
        command = FindEmployeeCommand.COMMAND_WORD + " " + FindEmployeeCommand.TYPE + " Daniel Benson";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find multiple persons in address book, 2 keywords with 1 repeat -> 2 persons found */
        command = FindEmployeeCommand.COMMAND_WORD + " " + FindEmployeeCommand.TYPE + " Daniel Benson Daniel";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
        ...
        command = FindEmployeeCommand.COMMAND_WORD + " " + FindEmployeeCommand.TYPE + " MeIeR";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find person in address book, keyword is substring of name -> 0 persons found */
        command = FindEmployeeCommand.COMMAND_WORD + " " + FindEmployeeCommand.TYPE + " Mei";
        ModelHelper.setFilteredList(expectedModel);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find person in address book, name is substring of keyword -> 0 persons found */
        command = FindEmployeeCommand.COMMAND_WORD + " " + FindEmployeeCommand.TYPE + " Meiers";
        ModelHelper.setFilteredList(expectedModel);
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();

        /* Case: find person not in address book -> 0 persons found */
        command = FindEmployeeCommand.COMMAND_WORD + " " + FindEmployeeCommand.TYPE + " Mark";
        assertCommandSuccess(command, expectedModel);
        assertSelectedCardUnchanged();
