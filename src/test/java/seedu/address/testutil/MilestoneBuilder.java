...
public class MilestoneBuilder {
    ...
    public MilestoneBuilder() {
        this.milestoneDesc = new Description(DEFAULT_MILESTONE_DESC);
    ...
    public MilestoneBuilder(Milestone milestoneToCopy) {
        this.milestoneDesc = new Description(milestoneToCopy.getMilestoneDescription().description);
    ...
    public MilestoneBuilder withDescription(String description) {
        this.milestoneDesc = new Description(description);
        return this;
    }
