...
public class CommandTestUtil {
    ...
    public static final String TAG_DESC_FRIEND = " " + PREFIX_TAG + VALID_SKILL_FRIEND;
    public static final String TAG_DESC_HUSBAND = " " + PREFIX_TAG + VALID_SKILL_HUSBAND;
    ...
    static {
        DESC_AMY = new EditEmployeeDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_SKILL_FRIEND).build();
