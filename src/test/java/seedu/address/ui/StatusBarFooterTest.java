...
public class StatusBarFooterTest extends GuiUnitTest {
    ...
    @Before
    public void setUp() {
        StatusBarFooter statusBarFooter = new StatusBarFooter(STUB_SAVE_LOCATION, pocketProject);
    ...
    public void display() {
        ...
        // after pocket project is updated
        guiRobot.interact(() -> pocketProject.addEmployee(ALICE));
