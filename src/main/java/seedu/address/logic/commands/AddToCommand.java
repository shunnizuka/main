...
public abstract class AddToCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + " PROJECT_NAME employee/milestone/userstory/task"
            + ": adds the employee/milestone/user story/task into the selected project.\n";
}
